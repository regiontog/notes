...
```bash
$ ftp 10.129.246.226
Connected to 10.129.246.226.
220 (vsFTPd 3.0.3)
Name (10.129.246.226:root): anonymous
...
ftp> ls
229 Entering Extended Passive Mode (|||50987|)
...
```
### Response Codes
**[FTP](https://en.wikipedia.org/wiki/File_Transfer_Protocol "File Transfer Protocol") [server](https://en.wikipedia.org/wiki/Server_\(computing\) "Server (computing)") return codes** always have three digits, and each digit has a special meaning.[[1]](https://en.wikipedia.org/wiki/List_of_FTP_server_return_codes#cite_note-1) The first digit denotes whether the response is good, bad or incomplete:
...
|`336`|Username okay, password okay. [Challenge](https://en.wikipedia.org/wiki/Challenge%E2%80%93response_authentication "Challenge–response authentication") is "....".|
